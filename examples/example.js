 ...
 */
 ...
 (function() {
    ...
    window.addEventListener("load",function() {
        ...
        // const factory = TGH.DefaultFactory;
        ...
        //   side: THREE.DoubleSide
        // })
        var mapMaterial = new THREE.MeshNormalMaterial({
            side: THREE.DoubleSide,
            wireframe: true
          });
    ...
    //     scene.add( new THREE.Mesh( geom, mapMaterial ) );
        ...
        // geom.computeVertexNormals();
        // geom.computeMorphNormals();
        // bgeom = TGH.Gmetry.createBufferGeometryFromObject(geom);
        bgeom = geom.toBufferGeometry();
        console.log("bgeom",bgeom);
        scene.add( new THREE.Mesh( bgeom, mapMaterial ) );
